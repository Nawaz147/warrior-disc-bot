...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const weaponChance = 0.01; // 1% chance to get weapons
    const minPlatinum = 5;
    ...
    if (args[0] === "buy" && args[1] === "lockedCrateOfEnergy") {
      ...
      let timeLeft = nextResetTime - currentTime;
      ...
      // Show the store with locked crate of energy available for purchase
