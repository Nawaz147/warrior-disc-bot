...
//               "attained",
//             ];
//             const getRandomLootText = () => {
//               const randomIndex = Math.floor(
//                 Math.random() * randomLootText.length
//               );
//               return randomLootText[randomIndex];
//             };
//             var randomGoldCoins = Math.floor(Math.random() * 3591) + 1890;
...
//                         "```" +
//                           `diff
// -${user.username} ${getRandomLootText()} : The cursed pumpkin
// ` +
//                           "```"
//                       );
...
//                         .setDescription(
//                           `
// ${user.username} claimed : <a:hallowcharmToken:1164785382517395547> ${hallowcharmToken} Hallowcharm token
// `
//                         )
//                         .setColor(`#2B2D31`);
...
//                         "```" +
//                           `diff
// ${user.username} ${getRandomLootText()} : Witch's Brew Cauldron
// ` +
//                           "```"
//                       );
//                       const hallowcharmTokenEmbed = new Discord.MessageEmbed()
...
//                         "```" +
//                           `fix
// ${user.username} ${getRandomLootText()} : Ebonrose Perfume
// ` +
//                           "```"
//                       );
//                       const hallowcharmTokenEmbed = new Discord.MessageEmbed()
...
//                         "```" +
//                           `fix
// ${user.username} ${getRandomLootText()} : Dark elixir
// ` +
//                           "```"
//                       );
//                       const hallowcharmTokenEmbed = new Discord.MessageEmbed()
...
//                         "```" +
//                           `fix
// ${user.username} ${getRandomLootText()} : Shadowveil Reflectoscope
// ` +
//                           "```"
//                       );
//                       const hallowcharmTokenEmbed = new Discord.MessageEmbed()
...
//                         "```" +
//                           `css
// [${user.username} ${getRandomLootText()} : Elite awakening gem]
// ` +
//                           "```"
//                       );
//                       const hallowcharmTokenEmbed = new Discord.MessageEmbed()
...
//                         "```" +
//                           `
// ${user.username} ${getRandomLootText()} : Awakening gem
// ` +
//                           "```"
//                       );
//                       const hallowcharmTokenEmbed = new Discord.MessageEmbed()
...
//                             `diff\n${
//                               user.username
//                             } ${getRandomLootText()} : Chocolate bar\n` +
//                             "```"
//                         );
...
//                             `diff\n${
//                               user.username
//                             } ${getRandomLootText()} : Spoiled pumpkin\n` +
//                             "```"
//                         );
...
//                             `diff\n${
//                               user.username
//                             } ${getRandomLootText()} : Wraith Scraps\n` +
//                             "```"
//                         );
//                         const hallowcharmTokenEmbed = new Discord.MessageEmbed()
//                           .setDescription(
...
//                             `diff\n${
//                               user.username
//                             } ${getRandomLootText()} : Awakening gem\n` +
//                             "```"
//                         );
//                         const hallowcharmTokenEmbed = new Discord.MessageEmbed()
//                           .setDescription(
...
//                             amount: 100000,
//                             aps: 100,
//                             key: "${getRandomLootText()}AHeftySumOf100k",
//                             title:
...
//                           }
//                         }
//                         db.add(`totalMoneyInEconomy`, finalCoins);
...
//                           "```" +
//                             `diff
// ${user.username} ${getRandomLootText()} : ${finalCoins} Gold Coins
// ` +
//                             "```"
//                         );
//                       }
