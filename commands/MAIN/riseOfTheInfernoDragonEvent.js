...
//               db.set(`infernothTheEmberwingBossHealth_${tokenDB}`, 740860);
...
//               db.fetch(`infernothTheEmberwingBossHealth_${tokenDB}`) || 740860;
...
//                 .toString()
//                 .replace(/\B(?=(\d{3})+(?!\d))/g, ",");
//               var bossHealthProgress = `${currentBossHealth} / 740,860`;
//             } else {
//               var bossHealthProgress = `0 / 740,860`;
//             }
//             if (
