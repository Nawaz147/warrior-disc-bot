...
//   name: "testplay",
//   aliases: ["tp"],
//   description: "To test play the event",
//   usage: "testplay",
//   category: "Economy",
...
//                     message.channel.send(`You received : Warrior Pack`);
...
//                     message.channel.send(`You received : 3,250 platinum`);
//                     db.add(`WarriorEventPoints_${tokenDB}`, randomPoints);
//                   }
//                 } else if (chance <= 2.5) {
//                   message.channel.send(`You received : Warrior mask`);
//                   db.add(`WarriorMask_${tokenDB}`, 1);
//                   db.add(`WarriorEventPoints_${tokenDB}`, randomPoints);
//                 } else {
//                   bal = db.fetch(`money_${tokenDB}.pocket`);
//                   if (randomGoldCoins + bal > moneyCap.moneyCap) {
