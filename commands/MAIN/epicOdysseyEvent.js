...
//               // ... (remaining existing code)
//             } else {
//               var pheonixKingPyroclastorBossHealth = db.fetch(
//                 `pheonixKingPyroclastorBossHealth_${tokenDB}`
//               );
//               if (
//                 pheonixKingPyroclastorBossHealth == null ||
//                 pheonixKingPyroclastorBossHealth == undefined
//               ) {
//                 var pheonixKingPyroclastorBossHealth = 1280986;
//                 db.set(`pheonixKingPyroclastorBossHealth_${tokenDB}`, 1280986);
//               }
//               var ValoriumBoss = "Phoenix King Pyroclastor";
...
//               }
//               if (pheonixKingPyroclastorBossHealth < 0) {
//                 weaponDamage = weaponDamage
//                   .toString()
//                   .replace(/\B(?=(\d{3})+(?!\d))/g, ",");
//                 const pheonixKingPyroclastorBossEmbed2 =
//                   new Discord.MessageEmbed()
//                     .setTitle(`${ValoriumBoss}`)
//                     .setDescription(`${user} you hit ${ValoriumBoss}`)
//                     .addField(`Phoenix King Pyroclastor`, `1,510,340`)
//                     .addField(`Phoenix King Pyroclastor current health`, `0`)
//                     .addField(`Your damage`, `${weaponDamage}`)
//                     .setColor("#FF4500");
//                 message.channel.send(pheonixKingPyroclastorBossEmbed2);
...
//                   .toString()
//                   .replace(/\B(?=(\d{3})+(?!\d))/g, ",");
//                 pheonixKingPyroclastorBossHealth =
//                   pheonixKingPyroclastorBossHealth
//                     .toString()
//                     .replace(/\B(?=(\d{3})+(?!\d))/g, ",");
//                 const pheonixKingPyroclastorBossEmbed =
//                   new Discord.MessageEmbed()
//                     .setTitle(`${ValoriumBoss}`)
//                     .setDescription(`${user} you hit ${ValoriumBoss}`)
//                     .addField(`Phoenix King Pyroclastor`, `1,510,340`)
//                     .addField(
//                       `Phoenix King Pyroclastor current health`,
//                       `${pheonixKingPyroclastorBossHealth}`
//                     )
//                     .addField(`Your damage`, `${weaponDamage}`)
//                     .setColor("#FF4500");
//                 message.channel.send(pheonixKingPyroclastorBossEmbed);
//                 db.set(`cooldown_${tokenDB}`, Date.now());
//               }

//               if (
//                 pheonixKingPyroclastorBossHealth == 0 ||
//                 pheonixKingPyroclastorBossHealth < 0
//               ) {
//                 const phoenixKingPyroclastorBossDead =
//                   new Discord.MessageEmbed()
//                     .setTitle(`${ValoriumBoss}`)
//                     .setDescription(`${user} you killed ${ValoriumBoss}`)
//                     .setColor("#B88419");
//                 message.channel.send(phoenixKingPyroclastorBossDead);
