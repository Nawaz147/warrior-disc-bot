...
//   name: "play",
//   aliases: ["Play"],
//   description: "To play rise of the inferno dragon event",
//   usage: "play",
//   category: "Economy",
...
//       } else if (args[0] == "hit") {
//         var userTokenDB = db.table(`tokenDB_${message.author}`);
//         const partyData = userTokenDB.get(`party`) || {
//           leader: null,
//           members: [],
//         };
//         const partyMembers = partyData.members;
//         for (const memberData of partyData.membersData) {
//           const memberId = memberData.userId;
//           const equippedWeapon = memberData.equippedWeapon;
//           const weaponDamage = memberData.weaponDamage;

//           // Now you have the memberId, equippedWeapon, and weaponDamage for each party member
//           // You can use this data as needed
//           console.log(
//             `Member ${memberId} has ${equippedWeapon} with weapon damage ${weaponDamage}`
//           );
//         }
//         // Access the list of party members
...
//               db.set(`infernothTheEmberwingBossHealth_${tokenDB}`, 2210902);
...
//               db.fetch(`infernothTheEmberwingBossHealth_${tokenDB}`) || 2210902;
...
//                 .toString()
//                 .replace(/\B(?=(\d{3})+(?!\d))/g, ",");
//               var bossHealthProgress = `${currentBossHealth} / 2,210,902`;
//             } else {
//               var bossHealthProgress = `0 / 2,210,902`;
//             }
//             if (
...
//                       infernothTheEmberwingBossHealth !== 2210902
//                     ) {
...
//                       .addField(
//                         `${infernothTheEmberwingBossHealth} / 2,210,902`,
//                         `${bossHealthBar}`,
//                         true
//                       )
//                       .setImage(
